    ...
    <div class="form-dialog">
      <div class="form-dialog-header">
        ...
        <div>
          ...
          <p>Set a new password for <strong>{{ data.firstName }} {{ data.lastName }}</strong></p>
        </div>
      </div>
...
export class ResetPasswordDialogComponent {
  ...
  save() {
    ...
    this.saving = true;
    this.error  = '';
    this.userService.resetPassword(this.data.id, this.form.value.newPassword!).subscribe({
